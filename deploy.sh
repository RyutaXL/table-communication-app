...
echo ""
echo "🔑 IMPORTANT: Set Gemini API Key for translation features:"
echo "   gcloud run services update $SERVICE_NAME --set-env-vars GOOGLE_AI_API_KEY=YOUR_API_KEY --region $REGION"
echo ""
